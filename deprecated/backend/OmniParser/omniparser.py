...
config = {
    'som_model_path': 'weights/icon_detect/model.pt',  # Use model.pt directly
    'device': 'cuda' if torch.cuda.is_available() else 'cpu',  # Auto-detect GPU
    'caption_model_path': 'weights/icon_caption',  # Contains model.safetensors
    'draw_bbox_config': {
        'text_scale': 0.8,
        'text_thickness': 2,
        'text_padding': 3,
    ...
    'BOX_TRESHOLD': 0.03  # Lower threshold for better detection in v2.0
}
