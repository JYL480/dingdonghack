...
class DeploymentState(TypedDict):
    ...
    # Folder organization
    task_folder: Optional[str]  # Folder name for organizing screenshots
    max_steps: Optional[int]  # Maximum steps to prevent infinite loops
...
def create_deployment_state(
    ...
    # Task folder for screenshot organization (will be set later)
    state["task_folder"] = None
    state["max_steps"] = 20  # Default max steps
