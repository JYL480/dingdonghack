...
# Sync function to return LLM output (no async/await here)
...
# Sync function to process image and return a 'yes' or 'no' response
...
# Synchronous function to take a screenshot from the device
...
# Synchronous function to record video from the device
def record_video(
    device: str = "emulator",
...
# Synchronous function to get connected devices
